(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "./readonly-merge", "@dikac/t-validatable/callback", "@dikac/t-validatable/memoize"], factory);
    }
})(function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    const readonly_merge_1 = require("./readonly-merge");
    const callback_1 = require("@dikac/t-validatable/callback");
    const memoize_1 = require("@dikac/t-validatable/memoize");
    /**
